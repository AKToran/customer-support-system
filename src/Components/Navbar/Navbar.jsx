  ...
  return (
    <div className="navbar bg-base-100 shadow-sm lg:px-8">
      ...
      <div className="navbar-end">
        <ul className="menu menu-horizontal hidden lg:flex px-1 font-semibold">
          <li><a>Home</a></li>
          <li><a>FAQ</a></li>
          <li><a>Changelog</a></li>
          <li><a>Blog</a></li>
        ...
        <a className="btn text-white bg-linear-to-r from-purple-800 via-purple-600 to-purple-500"><span className="mr-2">+</span> New Ticket</a>
      </div>
    </div>
  );
};
